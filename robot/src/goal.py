...
KeyWord = {"ไปหยิบ":"pick",
            "ไปหยิบเนื้อ":"pick_meat",
            "ไปหยิบปลา":"pick_fish",
            "ไปหยิบผัก ":"pick_vegetable",
            "ไปหยิบถั่ว":"pick_bean",         
            }



Goal = {"pick_meat":[3.37,-3.9,-0.6601,0.7511],
        "pick_fish":[-3.927,3.051,-0.6601,0.7511],
        "pick_vegetable":[2.415,2.327,-0.6601,0.7511],
        "pick_bean":[-2.102,-6.78,-0.6601,0.7511],
        
        "Standby_Station":[0,0,-0.6601,0.7511]}
